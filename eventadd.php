  ...
  <head>
    ...
    <script>
        ...
        function addevent()
        {
			...
			document.getElementById("days").value = days.toString();
			document.getElementById("AddEvent").value = "Yes";
			document.form.submit();
        }
...
?>
	...
	<form class='form-inline' method='post' action='timeline.php' name='form' enctype='multipart/form-data'>
        <center><strong>Event date? &nbsp;</strong><div class='input-append'>
        <input type='text' id='day' class='span1'><span class='add-on'>day(s)</span>
        <input type='text' id='month' class='span1'><span class='add-on'>month(s)</span>
        <input type='text' id='year' class='span1'><span class='add-on'>year(s)</span>
        </div></center>
	...
	?>        
        <p>&nbsp;</p><h5><center>Attach a map</center></h5>
        <center><label for='file'><strong>Upload Image: &nbsp;</strong></label>
	...
	?> 
		...
		<input type='hidden' name='AddEvent' id='AddEvent' value=''></input>
        <p align=center><button type='button' class='btn btn-large btn-success' onClick='addevent();'>Add Event !</button></p>
